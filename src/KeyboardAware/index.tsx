// Taken from https://github.com/APSL/react-native-keyboard-aware-scroll-view
...
// @ts-ignore
export type KeyboardAwareHOCProps = keyboardAwareHOCTypeEvents & {
...
export type KeyboardAwareHOCOptions =
    | {
          enableOnAndroid: boolean;
          contentContainerStyle: Object | null | undefined;
          enableAutomaticScroll: boolean;
          extraHeight: number;
          extraScrollHeight: number;
          enableResetScrollToCoords: boolean;
...
function KeyboardAwareHOC(
    ...
    return class
        ...
        keyboardWillShowEvent: Function | null | undefined;
        keyboardWillHideEvent: Function | null | undefined;
        position: ContentOffset;
        defaultResetScrollToCoords: {x: number; y: number} | null | undefined;
        ...
        getScrollResponder = () => {
            return (
                ...
                // This is specific for DraggableFlatList onRef prop
        ...
        _measureElement = (
            ...
            return new Promise((resolve: (arg0: ElementLayout) => void) => {
        ...
        _handleOnScroll = (
            e: React.SyntheticEvent<any> & {
                nativeEvent: {contentOffset: number};
            },
        ) => {
           // @ts-ignore
        ...
        _handleRef = (ref: React.Component<any>) => {
